...
class NavigationMenuOrderable(Orderable):
    ...
    panels = [
        ...
        HelpPanel(
            content=(
                "Internal link takes priority over external link. Link text will be be"
                " taken from internal link's title if you choose not to set it."
            )
        ),
    ]
...
class SitewideMenus(ClusterableModel, BaseSetting):
    ...
    panels = [
        HelpPanel(
            content=(
                "<p>Use this to select menus to be used as the main interface for"
                " navigating our website.</p><p>CAUTION: These settings are very"
                " important! You should not clear, choose another, or edit these menus"
                " unless headers or footers on the site look incorrect.</p>"
            ),
            heading="Help",
        ),
        MultiFieldPanel(
            ...
            heading="Main Header",
            help_text=(
                "Will appear in header of every page of the site, in header, or in"
                " special menu on mobile"
            ),
        ),
        MultiFieldPanel(
            [
        ...
        MultiFieldPanel(
            ...
            help_text=(
                "Links that will appear in the mobile menu alongside the main header"
                " links"
            ),
        ),
    ]
