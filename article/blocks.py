        ...
        blocks.StructBlock(
            [
                ...
                (
                    "id",
                    blocks.CharBlock(
                        help_text="Intended to be shared with a header so that this button will send the user to the section of the page with said header"
                    ),
                ),
...
class HeaderLinkBlock(blocks.StructBlock):
    title = blocks.CharBlock()
    id = blocks.CharBlock(
        help_text="Intended to be shared with a page link button so that clicking the button will scroll the user to this header"
    )
...
class GalleryBlock(blocks.StructBlock):
    id = blocks.CharBlock(
        help_text="No numbers or spaces. Must be different from other ids defined in this article.",
        required=True,
    )
