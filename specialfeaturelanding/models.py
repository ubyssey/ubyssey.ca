...
class SpecialLandingPage(SectionablePage, UbysseyMenuMixin):
    ...
    content = StreamField(
        [
            (
                "quote",
                special_blocks.QuoteBlock(
                    label="Quote Block",
                ),
            ),
            (
                "stylecta",
                special_blocks.CustomStylingCTABlock(
    ...
    graphical_menu = StreamField(
        [
            (
                "menu_item",
                special_blocks.GraphicalMenuItemBlock(label="Graphical (Cover) Link"),
            ),
            ("menu_item", special_blocks.TextDivBlock(label="Text")),
        ],
        null=True,
        blank=True,
        use_json_field=True,
                    ...
                    FieldPanel(
                        ...
                        widget=Select(
                            choices=[
                                ...
                                (
                                    "guide-2020-section",
                                    "Guide (2020 Section Landing Page)",
                                ),
