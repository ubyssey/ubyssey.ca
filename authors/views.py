...
class BaseAuthorPageChooseView(BaseChooseView):
    ...
    def columns(self):
        return [
            self.title_column,
            Column("last_activity", label="Last Activity", accessor="last_activity"),
        ]


class AuthorPageChooseView(
    ChooseViewMixin, CreationFormMixin, BaseAuthorPageChooseView
):
    pass
...
class AuthorPageViewSet(ChooserViewSet):
    ...
    def get_object_list(self):
        return AuthorPage.objects.order_by(
