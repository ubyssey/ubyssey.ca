...
from events.views import EventsFeed, EventsViewSet, create_ical, update_events
...
from ubyssey.views.feed import AuthorFeed, FrontpageFeed, SectionFeed, TagFeed
from ubyssey.views.main import ads_txt, publish_scheduled, redirect_blog_to_humour
...
urlpatterns += (
    [
        ...
        re_path(
            r"^features/how-substance-use-impacts-queer-students",
            TemplateView.as_view(template_name="article/queer-substance-abuse.html"),
        ),
        re_path(
            r"^features/window-watching",
            TemplateView.as_view(template_name="article/nocturne-window-watching.html"),
        ),
        ...
        re_path(
            r"^cron/publish-scheduled/$", publish_scheduled, name="publish_scheduled"
        ),
        # Wagtail
