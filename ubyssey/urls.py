...
from ubyssey.views.feed import AuthorFeed, FrontpageFeed, SectionFeed
from ubyssey.views.guide import GuideArticleView, GuideLandingView, guide2016
from ubyssey.views.magazine import MagazineArticleView, MagazineLandingView, magazine
from ubyssey.views.main import (
    ArchiveView,
    ArticleAjaxView,
    ArticleView,
    AuthorView,
...
urlpatterns += (
    [
        ...
        re_path(
            r"^culture/special/self-isolation/",
            IsolationView.as_view(),
            name="special-isolation",
        ),
        re_path(
            r"^(?P<section>culture)/(?P<slug>boredom-and-binging|in-full-bloom|temperature-checks|a-breath-of-fresh-air|paradise-found|under-water|healing-wounds|feeling-raw)/$",
            ArticleView.as_view(),
        ),
        ...
        re_path(
            r"^search/$", ArchiveView.as_view(), name="search"
        ),  # to preserve URL but get rid of tiny redirect view
