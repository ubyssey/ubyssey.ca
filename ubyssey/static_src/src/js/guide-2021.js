...
$(document).ready(function () {
  ...
  dropDownHeader(
    "#c-nav-section--student-resources",
    "#c-section-more--student-resources",
  );
  dropDownHeader(
    "#c-nav-section--parties-sex-and-drugs",
    "#c-section-more--parties-sex-and-drugs",
  );
  dropDownHeader("#c-nav-section--vancouver", "#c-section-more--vancouver");
  dropDownHeader(
    "#c-nav-section--student-life",
    "#c-section-more--student-life",
  );
