...
function TeamContent(props) {
  ...
  `;
  const ribbonStyle = props.isDesktop
    ? { width: "50%", minWidth: "20rem", top: 0 }
    : { width: "100%", top: 0 };
  const primaryColor = props.isDesktop ? props.team.colors[0] : "#ffffff";
  return (
    <div
      className="c-n-content-box-container"
      style={props.isSelected ? { left: "0px" } : {}}
    >
      <div
        className="c-n-content-box"
        style={{
