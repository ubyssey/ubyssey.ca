        ...
        {this.state.showSplash && (
          <div className="adblock-container">
            ...
            <div className="adblock-content">
              ...
              <p>
                We know you don't come here for the ads. Ads help The Ubyssey
                bring you quality content and tell the stories that matter.
                Support your student newspaper.
              </p>
              <h3>Please disable adblock or whitelist ubyssey.ca</h3>
              {!navigator.cookieEnabled && (
                <em>
                  It looks like you have disabled cookies, the 'Don't ask again'
                  button may not work while cookies are disabled
                </em>
              )}
