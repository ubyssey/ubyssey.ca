...
class CookieDisclaimer extends React.Component {
  ...
  setCookie() {
    Cookies.set(this.getCookieName(), "accepted", { expires: 365, path: "/" });
  }
            ...
            <div className="cookie-disclaimer-container">
              ...
              <div className="c-row">
                <p>
                  ...
                  possible. Using this website means you accept our use of
                  cookies. You can disable cookies in your browser settings. We
                  respect your privacy and you can read more about our cookie
                  policy{" "}
                  <em>
                    <a
                      href={"https://www.ubyssey.ca/pages/cookie-policy-2020/"}
                    >
                      here
                    </a>
                  </em>
