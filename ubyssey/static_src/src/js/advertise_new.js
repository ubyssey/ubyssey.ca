...
$(function () {
  ...
  $(".o-placements--web .o-placements__placement").click(function () {
    $(".o-placements--web .o-placements__placement").removeClass(
      "o-placements__placement--active",
    );
    ...
    $(".o-placements--web .o-placements__demo__desktop").css(
      "top",
      $(this).data("offsetdesktop"),
    );
    $(".o-placements--web .o-placements__demo__mobile").css(
      "top",
      $(this).data("offsetmobile"),
    );
  });

  $(".o-placements--web .o-placements__platform--mode").click(function () {
    $(".o-placements--web .o-placements__platform--mode").removeClass(
      "o-placements__platforms--active",
    );
    $(this).addClass("o-placements__platforms--active");
    if ($(this).data("platform") == "desktop") {
      $(".o-placements--web .o-placements__demo").removeClass(
        "o-placements__demo--mobile",
      );
      $(".o-placements--web .o-placements__demo__desktop").removeClass(
        "o-hidden",
      );
      $(".o-placements--web .o-placements__demo__mobile").addClass("o-hidden");
      $(
        ".o-placements--web .o-placements__placement--demo--no_mobile",
      ).removeClass("o-unavailable");
    } else {
      $(".o-placements--web .o-placements__demo").addClass(
        "o-placements__demo--mobile",
      );
      $(".o-placements--web .o-placements__demo__desktop").addClass("o-hidden");
      $(".o-placements--web .o-placements__demo__mobile").removeClass(
        "o-hidden",
      );
      $(
        ".o-placements--web .o-placements__placement--demo--no_mobile",
      ).addClass("o-unavailable");
    }
  });

  $(".o-placements--print .o-placements__placement--demo").click(function () {
    $(".o-placements--print .o-placements__placement").removeClass(
      "o-placements__placement--active",
    );
    $(this).addClass("o-placements__placement--active");
    $(".o-placements--print .o-placements__demo").attr(
      "data-demo",
      $(this).data("demo"),
    );
  });
  ...
  $(".o-placements--guide .o-placements__placement--demo").click(function () {
    $(".o-placements--guide .o-placements__placement").removeClass(
      "o-placements__placement--active",
    );
    $(this).addClass("o-placements__placement--active");
    $(".o-placements--guide .o-placements__demo").attr(
      "data-demo",
      $(this).data("demo"),
    );
  });
  ...
  $(document).on("click", ".delete-cart-item", function (e) {
    ...
    document
      .getElementById(this.parentElement.id + "-selector")
  ...
  $(document).on("click", ".offer-link", function (e) {
    ...
    if (this.parentElement.classList.contains("selected")) {
      var text =
        String(
          this.parentElement.getElementsByClassName("offer-number")[0].value,
        ) +
        "x " +
        this.parentElement.getAttribute("offer");
      ...
      cartItem.innerHTML =
        "<a href='#' class='delete-cart-item'><i class='fa fa-close'></i></a><span>" +
        text +
        "</span>";
      document.getElementById("cart-container").appendChild(cartItem);
    } else {
      document
        .getElementById(this.parentElement.getAttribute("offerId"))
        .remove();
  ...
  $(document).on("change", ".offer-number", function (e) {
    var text =
      String(this.value) + "x " + this.parentElement.getAttribute("offer");
    cart[this.parentElement.getAttribute("offerId")] = text;
    document
      .getElementById(this.parentElement.getAttribute("offerId"))
      .getElementsByTagName("span")[0].innerHTML = text;
    updateCart();
  });
  ...
  function updateCart() {
    ...
    if (Object.keys(cart).length == 0) {
      ...
      document.getElementById("cart-header-span").innerHTML =
        "(" + String(Object.keys(cart).length) + " items)";
    }
  }
