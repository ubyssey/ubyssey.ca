...
var leftClasses = [
  "o-visual-essay__left-next",
  "o-visual-essay__left-show",
  "o-visual-essay__left-prev",
  "o-visual-essay__left-first",
];
var pastViewCount = 0;
var pastCount = 0;
...
document.body.onscroll = function () {
  ...
  var containers = document.getElementsByClassName(
    "o-visual-essay__content-container",
  );
  ...
  for (let i = 0; i < containers.length; i++) {
    ...
    if (containers[i].offsetTop + containers[i].offsetHeight < scrolled) {
      ...
      var left = containers[i].getElementsByClassName(
      ...
      var right = containers[i].getElementsByClassName(
      ...
      if (pastViewCount != viewCount) {
        ...
        containers[i].classList.add(
          containers[i]
            .getElementsByClassName("switch_view")
            [viewCount - 1].getAttribute("view"),
        );
      }
