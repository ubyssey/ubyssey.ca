...
function cleanJsTask() {
  return src("../static/ubyssey/js/", { read: false, allowEmpty: true }).pipe(
    clean({ force: true }),
  );
}

function cleanCssTask() {
  return src("../static/ubyssey/css/", { read: false, allowEmpty: true }).pipe(
    clean({ force: true }),
  );
}

function cleanImagesTask() {
  return src("../static/ubyssey/images/", {
    read: false,
    allowEmpty: true,
...
function cleanVideosTask() {
  return src("../static/ubyssey/videos/", {
    read: false,
    allowEmpty: true,
  }).pipe(clean({ force: true }));
}
...
function cleanFontsTask() {
  return src("../static/ubyssey/fonts/", {
    read: false,
    allowEmpty: true,
  }).pipe(clean({ force: true }));
}
...
function jasmineTask() {
  return src("./src/**/*.spec.js").pipe(jasmine({ verbose: true }));
}
...
function copyImagesTask() {
  return src("./src/images/**/*").pipe(dest("../static/ubyssey/images/"));
}

function copyVideosTask() {
  return src("./src/videos/**/*").pipe(dest("../static/ubyssey/videos/"));
}

function copyFontsTask() {
  return src("./src/fonts/**/*").pipe(dest("../static/ubyssey/fonts/"));
}
