...
class FacebookEventTests(DispatchAPITestCase):
    ...
    def test_invalid_event(self):
        ...
        try:
            event = FacebookEvent(url, api_provider=FacebookTest)
            self.fail(
                "The initialization of the event should have failed, as the url is an"
    ...
    def test_get_json(self):
        ...
        self.assertEqual(json["title"], "Halley's Comet Viewing")
    ...
    def test_get_json_for_invalid_event(self):
        ...
        try:
            ...
            self.fail(
                "The URL was invalid - test should have failed with FacebookEventError"
            )
    ...
    def test_get_image(self):
        ...
        self.assertEqual(
            image_url,
            "https://scontent.xx.fbcdn.net/v/t1.0-0/c19.0.50.50/p50x50/18839331_1384316584980194_5794442543874726327_n.jpg?oh=4de1936423586abaf991713425a796cc&oe=59AE129D",
        )
