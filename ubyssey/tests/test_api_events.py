...
class EventTests(DispatchAPITestCase, DispatchMediaTestMixin):
    ...
    def test_create_event(self):
        ...
        response = DispatchTestHelpers.create_event(
            self.client, location="Ubyssey", category="sports"
        )
    ...
    def test_update_event(self):
        ...
        self.assertEqual(updated_event.data["title"], "new title")
    ...
    def test_get_all_events(self):
        ...
        Event.objects.create(
            title="Test event 1", description="Test description", host="test host"
        )
        Event.objects.create(
            title="Test event 2", description="Test description", host="test host"
        )
        Event.objects.create(
            title="Test event 3", description="Test description", host="test host"
        )
    ...
    def test_get_events_submissions(self):
        ...
        event_1 = DispatchTestHelpers.create_event(
            self.client, title="Test 1", is_published=True
        )
        event_2 = DispatchTestHelpers.create_event(
            self.client, title="Test 2", is_published=True
        )
        event_3 = DispatchTestHelpers.create_event(
            self.client, title="Test 3", is_published=True, is_submission=True
        )
    ...
    def test_event_query(self):
        ...
        # Create events
        DispatchTestHelpers.create_event(
            self.client,
            title="A math lecture",
            description="Reimann Hypothesis",
            host="UBC",
        )
        DispatchTestHelpers.create_event(
            self.client,
            title="A physics lecture",
            description="A String Theory Query",
            host="UBC",
            is_published=True,
        )
        DispatchTestHelpers.create_event(
            self.client,
            title="Block Party!",
            description="Partay on the block",
            host="AMS",
        )
        DispatchTestHelpers.create_event(
            self.client,
            title="This is a user submission",
            host="Ubyssey",
            is_submission=True,
        )
        DispatchTestHelpers.create_event(
            self.client, title="This is one more user submission", host="Ubyssey"
        )
        DispatchTestHelpers.create_event(
            self.client, title="Category is music", category="music"
        )
        ...
        self.assertEqual(
            data_5["results"][0]["title"], "This is one more user submission"
        )
    ...
    def test_start_end_times(self):
        ...
        event = DispatchTestHelpers.create_event(
            self.client, start_time="2017-05-25 00:00", end_time="2017-05-26 00:00"
        )
